ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :quotes, :collection => {:contact => :post, :computer_changed => :get, :calculate => :post, :how_to_find => :get, :terms_and_conditions => :get, :submit_quote => :post, :grading => :get, :about_us => :get, :faq => :get}
